  ...
  return (
    <div className='h-screen place-content-center flex flex-col gap-4 text-2xl md:h-[98vh] lg:block lg:h-auto lg:place-content-normal'>
      ...
      <div className='flex flex-col mx-2 gap-4 md:block md:mx-4 lg:block'>
        ...
        <div className='mx-2 mt-2 flex flex-col gap-16 md:mx-4 md:mt-4 md:gap-8 lg:block'>
          <div className="flex flex-col gap-4 lg:block">
            ...
            <h1 className='ml-64 -mt-8 opacity-20 font-cursive text-base md:ml-88 md:text-lg lg:ml-132 lg:-mt-6'>
              {'</h1>'}
            </h1>
          </div>
          <div className="flex flex-col gap-4 lg:block">
