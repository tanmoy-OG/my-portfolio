      ...
      <CardContent className='flex w-full flex-col md:flex-row gap-4 md:gap-6 lg:gap-8'>
        ...
        <div className='basis-3/4 flex flex-col gap-3 md:gap-4'>
          <div className='flex flex-col gap-2'>
            <div className='w-fit flex flex-wrap gap-1 items-center'>
              <p className='text-base md:text-lg font-sans-desc font-extrabold flex flex-wrap items-center group-hover:text-accent transition-all peer'>{designation} {' '} <LuDot className='size-4 md:size-5 mt-0.5' /> {' '} {company} </p>
              {portal && <LuArrowUpRight className='size-4 md:size-5 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-accent transition-all' />}</div>
