...
const ExpProject = ({
  ...
  return (
    <div className='group z-20 relative'>
      ...
      />
      <Card className='py-6 md:py-7 lg:py-8 z-20 bg-secondary/50 backdrop-blur-xs shadow-secondary border-foreground/10 group-hover:border-foreground/20 group-hover:shadow-accent group-hover:shadow-lg/50 group-hover:-translate-y-2 group-hover:backdrop-blur-sm transition-all'>
        <CardContent className='flex w-full flex-col md:flex-row gap-4 md:gap-6 lg:gap-8'>
          ...
          <div className='basis-3/4 flex flex-col gap-4'>
            <div className='flex flex-col gap-2'>
              ...
              >
                <h1 className='text-base md:text-lg font-sans-desc font-extrabold group-hover:text-accent transition-all peer break-words'>
                  {title}
                </h1>
