...
const Experience = () => {
  return (
    <div className='flex flex-col justify-between gap-16 md:gap-24 lg:gap-32 px-4 md:px-6 lg:px-8 z-20 relative'>
        ...
        <div className='flex flex-col gap-4 lg:gap-8'>
          ...
          <div className="flex flex-col gap-8">
            ...
            <Link href='/archive/jobs' className='w-fit group z-20 flex gap-1 items-center hover:text-accent'>
              <h1 className='font-sans-desc font-bold text-sm md:text-lg lg:text-base' id='projects'>{'View Career History'}</h1>
      ...
      <div className='relative md:px-8'>
        ...
        <div className='mt-12 md:mt-18 lg:mt-24 flex flex-col gap-8'>
          ...
          <h1 className='-ml-4 md:-ml-10 lg:-ml-12 -mt-4 lg:mt-0 opacity-20 font-cursive text-sm md:text-base lg:text-lg' id='skills'>
            {'</section>'}
          </h1>
        </div>
      </div>
