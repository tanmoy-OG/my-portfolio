  ...
  return (
    <div className='px-4 md:px-14 lg:px-16 pb-8 lg:pb-0 flex flex-col gap-1 relative z-10 md:items-end'>
      <h1 className='font-sans-desc text-sm'>
        <span className='opacity-50 font-light tracking-wide'>
          Loosely designed in{' '}
        </span>
        <Link
          ...
          className='relative z-20 font-medium tracking-wide inline-block opacity-70 hover:opacity-100 hover:text-accent cursor-pointer transition-all'
        >
          Figma
        </Link>
        <span className='opacity-50 font-light tracking-wide'>
      ...
      <h1 className='font-sans-desc text-sm'>
        ...
        <Link
          href='https://github.com/tanmoy-OG/my-portfolio'
          target='_blank'
          rel='noopener noreferrer'
          className='relative z-20 font-medium tracking-wide inline-block opacity-70 hover:opacity-100 hover:text-accent cursor-pointer transition-all'
        >
