...
const SkillNAchieve = () => {
  return (
    <div
      id='skills'
      className='px-4 md:px-6 lg:px-8 flex flex-col justify-between gap-6 md:gap-7 lg:gap-8'
    >
      <div className='relative md:px-8'>
        <ShimmerText mt={510} ml={240} mlNegative={false} text='Skills' />
        <h1 className='md:-ml-6 lg:-ml-8 opacity-15 font-cursive text-base lg:text-lg'>
          {'<h1>'}
        </h1>
        <h1 className='ml-4 md:ml-0 text-4xl md:text-5xl text-accent break-words w-2/3 sm:w-full'>
          {'Skills & Achievements'}
        </h1>
          ...
          <div className='flex flex-col gap-3 md:gap-4'>
            {achievements.slice(0, 4).map((data, id) => (
              <Link
                ...
                className='ml-4 md:ml-0 font-sans-desc opacity-70 group hover:text-accent hover:opacity-100 transition-all hover:cursor-pointer text-sm md:text-lg lg:text-base z-20'
              >
